...
if __name__ == "__main__":
    ...
    n = 8 # power of 2
    q = t*9000000000000000000000000000000000000000000000000000 # q >> t, t divides q (and is an even multiple of t), q must be 300+ bits for practical security
